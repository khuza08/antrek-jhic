...
@section('content')
    <div x-data="galleryApp()" x-init="init()" class="p-4 mx-auto max-w-screen-2xl md:p-6">
                ...
                <tbody>
                    <template x-for="(gal, index) in galleries" :key="gal.id">
                        <tr class="border-b border-gray-700 hover:bg-gray-700">
                            ...
                            <td class="py-2 px-3">
                                <img :src="`/storage/${gal.image}`" alt="img" class="w-20 h-14 object-cover rounded"
                                    x-show="gal.image">
                            </td>
        ...
        <!-- Modal -->
        <div x-show="showModal" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
