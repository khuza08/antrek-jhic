    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="bg-gray-800 text-white rounded-lg shadow p-4">
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="bg-green-600 px-3 py-1 rounded hover:bg-green-500">Tambah Kategori</button>
            </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="py-2 px-3">Teknologi</td>
                        <td class="py-2 px-3">teknologi</td>
                        <td class="py-2 px-3">Kategori untuk artikel dan berita seputar teknologi.</td>
                    ...
                    <tr class="border-b border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="py-2 px-3">Olahraga</td>
                        <td class="py-2 px-3">olahraga</td>
                        <td class="py-2 px-3">Kategori untuk informasi dan berita olahraga.</td>
                        <td class="py-2 px-3">2025-10-14 09:00:00</td>
                        <td class="py-2 px-3">
                            <button class="bg-blue-600 px-3 py-1 rounded hover:bg-blue-500">Edit</button>
                            <button class="bg-red-600 px-3 py-1 rounded hover:bg-red-500">Hapus</button>
                    ...
                    <tr class="border-b border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="py-2 px-3">Lifestyle</td>
                        <td class="py-2 px-3">lifestyle</td>
                        <td class="py-2 px-3">Kategori tentang gaya hidup, tips, dan tren terbaru.</td>
                        <td class="py-2 px-3">2025-10-14 09:00:00</td>
                        <td class="py-2 px-3">
                            <button class="bg-blue-600 px-3 py-1 rounded hover:bg-blue-500">Edit</button>
                            <button class="bg-red-600 px-3 py-1 rounded hover:bg-red-500">Hapus</button>
