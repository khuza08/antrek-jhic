  ...
  return (
    <section className="relative flex items-center justify-center bg-white dark:bg-gray-800 px-4 py-12 sm:py-16 md:p-8 w-full min-h-screen md:h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col items-center max-w-4xl w-full gap-3 sm:gap-4 md:gap-6 text-center z-10 px-2 sm:px-4">
        ...
        <h1
          className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-inter leading-snug sm:leading-tight md:leading-none tracking-tight"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          Sekolahnya Sang <span className='italic font-extralight text-blue-600 dark:text-blue-400' style={{ fontFamily: "'Instrument Serif', serif" }}>Juara</span>  
